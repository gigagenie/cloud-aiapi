...
@interface SttAsyncClient ()<AVAudioPlayerDelegate, AVAudioRecorderDelegate>
...
- (IBAction)onRequest:(id)sender {
    ...
    [_manager restSTT:data mode:@(_mode) language:@"ko" encoding:_encoding channel:@(_channel) sampleRate:@(_sampleRate) sampleFmt:_sampleFmt?@"F32LE":@"S16LE" Block:^(ApiResult *result, SttResultInfo *resultInfo) {
