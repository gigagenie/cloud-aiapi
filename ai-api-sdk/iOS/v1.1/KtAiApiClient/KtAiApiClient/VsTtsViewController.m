#import "VsTtsViewController.h"
#import "AudioMgr.h"
#import <KTAIAPISDK/AIktManager.h>
#import "AppDelegate.h"

@interface VsTtsViewController ()<AudioDelegate, AVAudioPlayerDelegate>
...
@property (weak, nonatomic) IBOutlet UITextView *voiceNameView;
...
@implementation VsTtsViewController
...
- (IBAction)onRequest:(id)sender {
    ...
    NSLog(@"requestVSTTS");
    [manager requestVSTTS:_textView.text voiceName:_voiceNameView.text language:_langBtn.titleLabel.text speaker:@(_speakerCountLb.text.intValue) pitch:@(_pitchCountLb.text.intValue) speed:@(_speedCountLb.text.intValue) volume:@(_volumeCountLb.text.intValue) emotion:_emotionBtn.titleLabel.text encoding:_encodingBtn.titleLabel.text channel:@(_channel) sampleRate:@(_sampleRate) sampleFmt:_sampleFmt block:^(ApiResult *result, NSString *path) {
...
- (IBAction)onSelectEmotion:(id)sender {
    ...
    [actionSheet addAction:[UIAlertAction actionWithTitle:@"neutral" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        [self->_emotionBtn setTitle:@"neutral" forState:UIControlStateNormal];
