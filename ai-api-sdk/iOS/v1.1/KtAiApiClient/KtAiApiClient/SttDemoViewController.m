#import "SttDemoViewController.h"
#import <KTAIAPISDK/AIktManager.h>
#import "AppDelegate.h"
#import "AudioMgr.h"

@interface SttDemoViewController ()<AVAudioPlayerDelegate, AVAudioRecorderDelegate>
...
@implementation SttDemoViewController
...
- (IBAction)onRequest:(id)sender {
    ...
    [_manager requestSTT:data mode:@(_mode) language:@"ko" encoding:@"raw" channel:@(_channel) sampleRate:@(_sampleRate) sampleFmt:_sampleFmt?@"F32LE":@"S16LE" Block:^(ApiResult *result, SttResultInfo *resultInfo) {
