...
var fs = require("fs");
var notifier = require('./noti.js');
const grpcConnector = require('./grpc_connector');
...
class gRpc {
    ...
    VERSION_MINOR = 0;
    VERSION_BUILD = 0;
    CODE_NAME =  "KT_AI_API_SDK_STT_gRPC_" + this.VERSION_MAJOR + "." + this.VERSION_MINOR + "." + this.VERSION_BUILD;
    ...
    connectGRPC(){
        this.grpcClient = grpcConnector.grpc_connector(this.mServiceURL, this.mClientKey, this.mTimeStamp, this.mSignature);
